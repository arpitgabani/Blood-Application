package com.bloodapp.bda.Adapter;
...
import com.bloodapp.bda.Email.JavaMailApi;
import com.bloodapp.bda.Modal.User;
import com.bloodapp.bda.R;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder( @NonNull ViewHolder holder, int position ) {
        ...
        //holder.cityName.setText(user.getCityName());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView type, userName, userEmail, phoneNumber, cityName, bloodGroup;
